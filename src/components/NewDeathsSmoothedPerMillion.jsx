...
import { ParseNewDeathsSmoothedPerMillion } from '../utils/parseData';
...
const NewDeathsSmoothedPerMillionChart = forwardRef(({ selectedCountry6 }, ref) => {
  ...
  useEffect(() => {
    const { pakistanCases, saudiCases } = ParseNewDeathsSmoothedPerMillion();
...
export default NewDeathsSmoothedPerMillionChart;
